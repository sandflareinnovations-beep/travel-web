...
export default function BookingDetailPage() {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            // Capture the ticket component as canvas
            ...
            // Convert canvas to JPEG (more reliable than PNG with jsPDF)
            ...
            pdf.save(`flight-ticket-${booking?.PNR || transactionId}.pdf`);
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 py-10 px-4 print:p-0 print:bg-white">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-6 print:hidden">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button onClick={handleDownloadPDF} className="bg-blue-600 hover:bg-blue-700 rounded-xl shadow-lg shadow-blue-100">
            ...
            {/* Off-screen FlightTicket component for PDF generation */}
            <div style={{ position: 'absolute', left: '-9999px', top: 0 }}>
                <FlightTicket ref={ticketRef} booking={booking} />
            </div>
        </div>
    );
}